    ...
    return (
      ...
      /> */}
             ...
             transition-all flex items-center justify-between"
                >
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <svg
                            className={`w-5 h-5 text-gray-400 transition-transform ${activeSubmenu === 'bedrooms' ? 'rotate-180' : ''
                                }`}
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                ...
                {activeSubmenu === 'bathrooms' && (
                    <div className="px-5 py-4 bg-gradient-to-br from-gray-50 to-white border-t border-gray-100">
                        <div className="flex items-center justify-center gap-6">
                            ...
                            <span className="text-3xl font-bold text-gray-900 min-w-[60px] text-center">{bedrooms}</span>
                            <button
                                type="button"
            ...
            <div className="rounded-xl overflow-hidden border border-gray-200 bg-white shadow-sm">
                ...
                >
                    <span className="text-sm font-semibold text-gray-900">Check In – Check Out</span>
                    <div className="flex items-center gap-2">
                        {checkIn && checkOut && (
  ...
  className="w-full px-5 py-4 bg-white rounded-lg shadow-sm hover:bg-gray-50 
            ...
            <div className="rounded-xl overflow-hidden border border-gray-200 bg-white shadow-sm">
                <button
                    ...
                    className="w-full px-5 py-4 text-left hover:bg-gray-50 transition-colors flex items-center justify-between"
                >
                    <span className="text-sm font-semibold text-gray-900">Pet(s)?</span>
                    <div className="flex items-center gap-2">
                        {hasPets && (
                            <span className="text-xs text-gray-600 bg-gray-100 px-3 py-1 rounded-full">
                                {hasPets === 'yes' ? 'Yes' : 'No'}
...
export default CustomRealEstateSearchFormMobile