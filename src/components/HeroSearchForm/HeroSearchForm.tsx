...
import { CustomBookSearchForm } from './CustomBookSearchForm'
import { CustomRealEstateSearchForm } from './CustomRealEstateSearchForm'
...
export const formTabs: {
 ...
 // { name: 'RealEstates', icon: RealEstate02Icon, href: '/real-estate', formComponent: RealEstateHeroSearchForm },
  { name: 'CustomRealEstateSearchForm', icon: RealEstate02Icon, href: '/custom-real-estate', formComponent: CustomRealEstateSearchForm },
  { name: 'Flights', icon: Airplane02Icon, href: '/flight-categories/all', formComponent: FlightSearchForm },
  { name: 'CustomBookSearchForm', icon: House03Icon, href: '/', formComponent: CustomBookSearchForm },
