...
const HeroSectionWithSearchForm1 = ({
  ...
  return (
    <div className={clsx('relative flex flex-col-reverse pt-10 lg:flex-col lg:pt-12', className)}>
      ...
      {/* Desktop: centered absolute search form with constrained max width (positioned relative to the page) */}
      <div className="absolute left-0 right-0 bottom-4 hidden lg:block">
        <div className="mx-auto w-full max-w-[1280px] px-4">{searchForm}</div>
      </div>
    </div>
  )
}
